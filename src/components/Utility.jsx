...
const Utility = () => {
    return (
        <div className='bg-light px-4 -mt-1 pb-[265.1px]'>
            <div className=' flex flex-col text-center items-center md:text-start md:items-start md:flex-row gap-6 max-w-330 mx-auto pt-32.5 '>
                ...
                <div className='mt-20'>
                    <h2 className='text-custom-7xl text-white leading-100 font-normal '>UTI<span className='text-blacky'>LITY</span></h2>
