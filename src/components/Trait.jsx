...
const Trait = () => {
    return (
        <div className='-mt-1'>
            <div className="bg-[url('/assets/images/png/acer-bg.png')] pt-8 md:pt-12 lg:pt-[27.1px] bg-center bg-cover bg-no-repeat w-full min-h-[600px] md:min-h-[800px] lg:min-h-[1080.1px]">
                <div className='max-w-full lg:max-w-[1617.1px] mx-auto px-4 md:px-6 lg:px-0'>
                    ...
                    <div className='flex flex-row flex-wrap md:justify-between max-w-full md:max-w-330 mx-auto gap-6 md:gap-4 lg:gap-0'>
