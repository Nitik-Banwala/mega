    ...
    return (
        <div className='-mt-1'>
            <div className="bg-[url('/assets/images/png/teambg.png')] py-16 md:py-24 px-4 lg:py-[183.1px] w-full bg-center bg-cover bg-no-repeat min-h-[600px] md:min-h-[800px] lg:min-h-[1091.1px]">
                <h2 className='text-4xl md:text-5xl lg:text-custom-7xl text-white leading-100 font-normal text-center mb-8 md:mb-10 lg:mb-12'>TE<span className='text-blacky'>AM</span></h2>
