...
const Team = () => {
    return (
        <div className='-mt-1'>
            <div className="bg-[url('/assets/images/png/team-bg.png')] py-16 md:py-24 px-4 lg:py-[183.1px] w-full bg-center bg-cover bg-no-repeat min-h-[600px] md:min-h-[800px] lg:min-h-[1091.1px]">
